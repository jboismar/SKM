...
CREATE USER 'skmadmin'@'localhost' IDENTIFIED BY 'skmpassw0rd';

GRANT USAGE ON * . * TO 'skmadmin'@'localhost' IDENTIFIED BY 'skmpassw0rd' WITH MAX_QUERIES_PER_HOUR 0 MAX_CONNECTIONS_PER_HOUR 0 MAX_UPDATES_PER_HOUR 0 MAX_USER_CONNECTIONS 0 ;
